...
file(APPEND ${VERSION_FILENAME} "#ifndef COLLABVM_VERSION_H\n")
file(APPEND ${VERSION_FILENAME} "#define COLLABVM_VERSION_H\n")
...
file(APPEND ${VERSION_FILENAME} "namespace collabvm::version {\n")
...
if("${GIT_BRANCH}" STREQUAL "master")
	file(APPEND ${VERSION_FILENAME} "\t#define COLLABVM_VERSION_TAG \"${GIT_TAG}\"\n")
else()
	if("${GIT_TAG}" STREQUAL "${GIT_COMMIT}")
		# git describe --tags will fallback to shorthand commit if no tags can describe this version
		file(APPEND ${VERSION_FILENAME} "\t#define COLLABVM_VERSION_TAG \"${GIT_TAG}-${GIT_BRANCH}\"\n")
	else()
		# we actually have a tag, so do this instead
		file(APPEND ${VERSION_FILENAME} "\t#define COLLABVM_VERSION_TAG \"${GIT_TAG}-${GIT_COMMIT}-${GIT_BRANCH}\"\n")
	endif()
endif()
file(APPEND ${VERSION_FILENAME} "\t#define COLLABVM_VERSION_BRANCH \"${GIT_BRANCH}\"\n")
file(APPEND ${VERSION_FILENAME} "#endif // COLLABVM_VERSION_H\n")
